...
object Examples {
  ...
  def radianExamples: Unit = {
    ...
    line
      .defaultPaintOptions.strokeColor(Color.RED)
      .defaultPaintOptions.marker(Marker.diamond)
      .defaultPaintOptions.strokeWidth(3)
      .defaultPaintOptions.markerSize(30)
  }
