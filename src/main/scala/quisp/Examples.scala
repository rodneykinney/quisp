...
object Examples {
  ...
  def cityTemperatures = {
    import Data.CityTemperatures._
    import quisp.Plot._
  ...
  def populationGrowth = {
    ...
    area(years, oceana)
        ...
        .addSeries(years, america)
        .series(1).name("America")
        .addSeries(years, africa)
        .series(2).name("Africa")
        .addSeries(years, europe)
        .series(3).name("Europe")
        .addSeries(years, asia)
        .series(4).name("Asia")
  }

  def largestCities = {
    import quisp.Plot._
    import Data.LargestCities.data
    column(data)
  ...
  def heightVsWeight = {
    import Data.HeightVsWeight._
    import quisp.Plot._

    val fColor = new java.awt.Color(223, 83, 83, 128)
    val mColor = new java.awt.Color(119, 152, 191, 128)
    scatter(femaleData)
  ...
  object Data {
    object PopulationGrowth {
      ...
      val oceana = List(2, 2, 2, 6, 13, 30, 46)
      val america = List(18, 31, 54, 156, 339, 818, 1201)
      val africa  = List(163, 203, 276, 408, 547, 729, 628)
      val europe = List(106, 107, 111, 133, 221, 767, 1766)
      val asia = List(502, 635, 809, 947, 1402, 3634, 5268)
    }
    object BrowserShare {
      val data = List(
        ("Firefox", 45.0),
    ...
    object CityTemperatures {
      val months =
        List("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec")
      val tokyo = List(7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6)
      val newYork = List(-0.2, 0.8, 5.7, 11.3, 17.0, 22.0, 24.8, 24.1, 20.1, 14.1, 8.6, 2.5)
      val berlin = List(-0.9, 0.6, 3.5, 8.4, 13.5, 17.0, 18.6, 17.9, 14.3, 9.0, 3.9, 1.0)
      val london = List(3.9, 4.2, 5.7, 8.5, 11.9, 15.2, 17.0, 16.6, 14.2, 10.3, 6.6, 4.8)
    }
    object LargestCities {
      val data = List(
        ("Shanghai", 23.7),
        ("Lagos", 16.1),
        ("Instanbul", 14.2),
